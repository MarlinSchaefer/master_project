...
def get_submit_file(highLevel, lowLevel):
    ...
    '',
    'output          = ./out.Cl\$(Cluster).\$(Process).{}.{}'.format(highLevel, lowLevel),
    'error           = ./err.Cl\$(Cluster).\$(Process).{}.{}'.format(highLevel, lowLevel),
    'log             = ./log.Cl\$(Cluster).\$(Process).{}.{}'.format(highLevel, lowLevel),
    '',
    '',
