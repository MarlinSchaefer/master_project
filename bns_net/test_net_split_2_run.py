...
if __name__ == "__main__":
    run_net('tcn_net', 'templates', ini_file='testing_net.ini', create_wiki_entry=False, overwrite_template_file=False, epochs=4, use_data_object=True, show_snr_plot=False, overwrite_net_file=True, evaluate_on_large_testing_set=False, batch_size=24)
    #try:
