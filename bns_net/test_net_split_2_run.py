...
if __name__ == "__main__":
    run_net('test_dobj_net', 'mult_output_data_small', ini_file='testing_net.ini', snr=[10.0, 50.0], create_wiki_entry=True, overwrite_template_file=False, epochs=100, num_of_templates=200, gw_prob=0.5, use_data_object=True, show_snr_plot=False, custom_message='First longterm test of the new metric functions.', overwrite_net_file=True)
    #try:
