...
if __name__ == "__main__":
    run_net('pure_convolution_stack', 'small_snr_7_50000', ini_file='testing_net.ini', create_wiki_entry=True, overwrite_template_file=False, epochs=500, use_data_object=True, show_snr_plot=False, custom_message='Trying to reach comparable sensitivities at SNR in [8.0, 15.0]. Trying an old and simple version using just 6 convolution layers.', overwrite_net_file=True, evaluate_on_large_testing_set=False)
    #try:
