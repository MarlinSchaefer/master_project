...
if __name__ == "__main__":
    run_net('test_dobj_net', 'mult_output_data_tiny', ini_file='testing_net.ini', snr=[8.0, 15.0], create_wiki_entry=False, overwrite_template_file=False, epochs=100, num_of_templates=100000, gw_prob=0.5, use_data_object=True)
    #try:
