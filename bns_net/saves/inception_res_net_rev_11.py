...
class DataGenerator(keras.utils.Sequence):
    ...
    def __data_generation(self, indices):
        ...
        for i, idx in enumerate(indices):
            ...
            X[0][i][0] = self.signals[sig_ind].transpose()[1][2048:]
            X[0][i][1] = self.signals[sig_ind].transpose()[8][2048:]
            X[0][i][2] = self.signals[sig_ind].transpose()[1][:2048]
            X[0][i][3] = self.signals[sig_ind].transpose()[8][:2048]
            X[0][i][4] = self.signals[sig_ind].transpose()[3][:2048]
            X[0][i][5] = self.signals[sig_ind].transpose()[10][:2048]
            X[0][i][6] = self.signals[sig_ind].transpose()[5][:2048]
            X[0][i][7] = self.signals[sig_ind].transpose()[12][:2048]
            
            X[1][i][0] = self.noise[noi_ind].transpose()[1][2048:]
            X[1][i][1] = self.noise[noi_ind].transpose()[8][2048:]
            X[1][i][2] = self.noise[noi_ind].transpose()[1][:2048]
            X[1][i][3] = self.noise[noi_ind].transpose()[8][:2048]
            X[1][i][4] = self.noise[noi_ind].transpose()[3][:2048]
            X[1][i][5] = self.noise[noi_ind].transpose()[10][:2048]
            X[1][i][6] = self.noise[noi_ind].transpose()[5][:2048]
            X[1][i][7] = self.noise[noi_ind].transpose()[12][:2048]
