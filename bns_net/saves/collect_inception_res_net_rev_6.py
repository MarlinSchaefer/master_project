...
from custom_layers import custom_loss, WConv1D, loss_c1
...
def preprocess(inp):
    ...
    wconv = WConv1D(32, 20, 4096, waves_per_filter=96)(batch_1)
    bn_conv_1 = keras.layers.BatchNormalization()(wconv)
