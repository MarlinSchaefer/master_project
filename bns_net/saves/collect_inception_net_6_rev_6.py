...
def get_model():
    ...
    stack_1s = stack(inp1, NUM_DETECTORS, DROPOUT_RATE)
    stack_2s = stack(inp2, NUM_DETECTORS, DROPOUT_RATE)
    stack_4s = stack(inp4, NUM_DETECTORS, DROPOUT_RATE)
    stack_8s = stack(inp8, NUM_DETECTORS, DROPOUT_RATE)
    stack_16s = stack(inp16, NUM_DETECTORS, DROPOUT_RATE)
    stack_32s = stack(inp32, NUM_DETECTORS, DROPOUT_RATE)
    stack_64s = stack(inp64, NUM_DETECTORS, DROPOUT_RATE)
