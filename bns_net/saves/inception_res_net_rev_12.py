...
class DataGenerator(keras.utils.Sequence):
    ...
    def __data_generation(self, indices):
        ...
        for i, idx in enumerate(indices):
            ...
            X[0][i][2] = self.signals[sig_ind].transpose()[1]
            X[0][i][3] = self.signals[sig_ind].transpose()[8]
            X[0][i][4] = self.signals[sig_ind].transpose()[2]
            X[0][i][5] = self.signals[sig_ind].transpose()[9]
            X[0][i][6] = self.signals[sig_ind].transpose()[3]
            X[0][i][7] = self.signals[sig_ind].transpose()[10]
            X[0][i][8] = self.signals[sig_ind].transpose()[4]
            X[0][i][9] = self.signals[sig_ind].transpose()[11]
            X[0][i][10] = self.signals[sig_ind].transpose()[5]
            X[0][i][11] = self.signals[sig_ind].transpose()[12]
            X[0][i][12] = self.signals[sig_ind].transpose()[6]
            X[0][i][13] = self.signals[sig_ind].transpose()[13]
            
            X[1][i][0] = self.noise[noi_ind].transpose()[0]
            X[1][i][1] = self.noise[noi_ind].transpose()[7]
            X[1][i][2] = self.noise[noi_ind].transpose()[1]
            X[1][i][3] = self.noise[noi_ind].transpose()[8]
            X[1][i][4] = self.noise[noi_ind].transpose()[2]
            X[1][i][5] = self.noise[noi_ind].transpose()[9]
            X[1][i][6] = self.noise[noi_ind].transpose()[3]
            X[1][i][7] = self.noise[noi_ind].transpose()[10]
            X[1][i][8] = self.noise[noi_ind].transpose()[4]
            X[1][i][9] = self.noise[noi_ind].transpose()[11]
            X[1][i][10] = self.noise[noi_ind].transpose()[5]
            X[1][i][11] = self.noise[noi_ind].transpose()[12]
            X[1][i][12] = self.noise[noi_ind].transpose()[6]
            X[1][i][13] = self.noise[noi_ind].transpose()[13]
