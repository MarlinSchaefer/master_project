...
def get_model():
    ...
    dense_4 = keras.layers.Dense(2, activation='relu')(dense_3)
    out_bool = keras.layers.Lambda(custom_softmax, name='Out_Bool')(dense_4)
    
    model = keras.models.Model(inputs=[is1, in1, is2, in2, is3, in3, is4, in4, is5, in5, is6, in6, is7, in7, is8, in8], outputs=[dense_2, out_bool, tcn1, tcn2, tcn3, tcn4, tcn5, tcn6, tcn7, tcn8, aux_11, aux_12, aux_13, aux_14, aux_21, aux_22])
