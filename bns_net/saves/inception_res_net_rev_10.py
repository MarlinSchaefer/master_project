...
def get_model():
    ...
    drop_1 = keras.layers.Dropout(DROPOUT_RATE)(batch_1)
    conv_1 = keras.layers.Conv1D(int(3.5 * FILTER_NUM), 32)(drop_1)
    bn_conv_1 = keras.layers.BatchNormalization()(conv_1)
    act_conv_1 = keras.layers.Activation('relu')(bn_conv_1)
    pool_conv_1 = keras.layers.MaxPooling1D(4)(act_conv_1)
    conv_2 = keras.layers.Conv1D(7 * FILTER_NUM, 16)(pool_conv_1)
    bn_conv_2 = keras.layers.BatchNormalization()(conv_2)
    act_conv_2 = keras.layers.Activation('relu')(bn_conv_2)
    
    #Inception layers
    inc_1 = res_incp(act_conv_2)
    inc_2 = res_incp(inc_1)
    inc_3 = res_incp(inc_2)
    inc_4 = res_incp(inc_3)
    inc_5 = res_incp(inc_4)
    inc_6 = res_incp(inc_5)
    inc_7 = res_incp(inc_6)
    inc_8 = res_incp(inc_7)
    
    pool_2 = keras.layers.MaxPooling1D(4)(inc_8)
