...
def combine_stack(in1, in2):
    ...
    l_add_1 = keras.layers.Add()([lb1, lb2])
    l3 = incp_lay(l_add_1, 32)
    lb3 = keras.layers.BatchNormalization()(l3)
    l_add_2 = keras.layers.Add()([l_add_1, lb3])
    
    r1 = incp_lay(in2, 32)
    rb1 = keras.layers.BatchNormalization()(r1)
    r2 = incp_lay(rb1, 32)
    rb2 = keras.layers.BatchNormalization()(r2)
    r_add_1 = keras.layers.Add()([rb1, rb2])
    r3 = incp_lay(r_add_1, 32)
    rb3 = keras.layers.BatchNormalization()(r3)
    r_add_2 = keras.layers.Add()([r_add_1, rb3])
    
    out = keras.layers.concatenate([l_add_2, r_add_2])
