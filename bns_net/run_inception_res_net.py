...
if __name__ == "__main__":
    try:
        msg = 'ATTENTION: CHANGED THE DEFAULT IMPORT SIZE IN D_OBJ! This network is collect_inception_res_net_rev_1, but trained using a new loss function, that tries to separate pure noise and GW signals more strongly, by introducing an exponential penalty for overestimating large SNR values and underestimating large SNR values. (Trained using mse, metric mape)'
