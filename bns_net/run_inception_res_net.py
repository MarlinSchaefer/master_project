...
if __name__ == "__main__":
    try:
        msg = 'ATTENTION: CHANGED THE DEFAULT IMPORT SIZE IN D_OBJ! This network is collect_inception_res_net_rev_5 from the prior run, but uses the default Adam optimizer instead of one with the learning rate lowered to 1e-6. (Trained using mse, metric mape)'
