...
if __name__ == "__main__":
    try:
        msg = 'This network is the one inception_res_net should have been. It fixes some wrong connections in the network.'
    ...
    try:
        msg = 'This network architecturally is the same as inception_res_net_rev_5, but increases the number of filters in each inception layer.'
