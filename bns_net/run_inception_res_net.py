...
if __name__ == "__main__":
    try:
        msg = 'ATTENTION: CHANGED THE DEFAULT IMPORT SIZE IN D_OBJ! This network is collect_inception_res_net_rev_6 from the prior run, but uses mean squared error as the loss function. (To compare against convolution layer.)'
