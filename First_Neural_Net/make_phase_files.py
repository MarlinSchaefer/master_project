...
def payload(i):
    ...
    if gw_present:
        hp, hc = get_td_waveform(approximant=APPROXIMANT, mass1=MASS1, mass2=MASS2, delta_t=DELTA_T, f_lower=F_LOWER, phase=random() * 2 * np.pi, distance=1)
        strain = hp
